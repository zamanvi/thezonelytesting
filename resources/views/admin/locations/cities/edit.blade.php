            ...
            <div class="col-lg-6">
                <div class="section-card">
                    ...
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center p-4">
                        ...
                        <a href="{{ route('admin.states.cities.create', $state) }}" class="btn btn-light btn-sm">
                            <i class="fas fa-plus me-1"></i> Create New City
                        </a>
                    </div>

                    <div class="card-body p-4">
                        <form method="POST" action="{{ route('admin.states.cities.update', [$state, $city]) }}">
                            @csrf
                            @method('PUT')
                            ...
                            {{-- Title --}}
                            <div class="mb-3">
                                <label class="form-label" for="title">City Title</label>
                            ...
                            {{-- Slug --}}
                            <div class="mb-3">
                                <label class="form-label" for="slug">City Slug</label>
                            ...
                            <div class="form-check mb-4">
                                ...
                                <input type="checkbox" name="status" value="1" class="form-check-input"
                                    id="status" {{ old('status', $city->status) ? 'checked' : '' }}>
