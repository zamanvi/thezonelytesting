<nav class="sidebar" id="sidebar">
    <div class="d-flex align-items-center justify-content-between mb-5">
        <h3 class="mb-0 logo-text"><a href="{{ route('admin.dashboard') }}" class="@if (Route::is('admin.dashboard')) active @endif"><i class="fas fa-home me-2"></i>Zonely</a></h3>
        <i class="fas fa-bars btn-toggle-sidebar text-white" id="toggleSidebar"></i>
    </div>
    <ul class="nav flex-column">
        <li class="nav-item mb-2"><a href="{{ route('admin.blogs.create') }}" class="@if (Route::is(['admin.blogs.create', 'admin.blogs.show', 'admin.blogs.edit'])) active @endif"><i class="fas fa-users"></i><span class="nav-text ms-3">Blog Management</span></a></li>
        <li class="nav-item mb-2"><a href="{{ route('admin.profiles.index') }}" class="@if (Route::is(['admin.profiles.index'])) active @endif"><i class="fas fa-users"></i><span class="nav-text ms-3">All Profiles</span></a></li>
        <li class="nav-item mb-2"><a href="{{ route('admin.vehicles.index') }}" class="@if (Route::is(['admin.vehicles.index', 'admin.vehicles.create', 'admin.vehicles.show', 'admin.vehicles.edit', 'admin.policies.create', 'admin.policies.show', 'admin.policies.edit', 'admin.payments.create', 'admin.payments.show', 'admin.payments.edit'])) active @endif"><i class="fas fa-users"></i><span class="nav-text ms-3">All Vehicles</span></a></li>
        <li class="d-none nav-item mb-2"><a href="{{ route('admin.categories.index') }}" class="@if (Route::is(['admin.categories.create', 'admin.categories.show', 'admin.categories.edit'])) active @endif"><i class="fas fa-users"></i><span class="nav-text ms-3">Categories</span></a></li>
        <li class="d-none nav-item mb-2"><a href="{{ route('admin.services.index') }}" class="@if (Route::is(['admin.services.create', 'admin.services.show', 'admin.services.edit'])) active @endif"><i class="fas fa-users"></i><span class="nav-text ms-3">Services</span></a></li>
