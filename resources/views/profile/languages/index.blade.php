    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex justify-end">
                <a href="{{ route('profile.languages.create') }}" 
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <div class="p-2 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-700">Language Records</h3>
                </div>
                ...
                <div class="overflow-x-auto">
                            ...
                            <tbody class="bg-gray-100 divide-y divide-gray-200">
                                @foreach($languages as $language)
                                    <tr class="hover:bg-gray-50 transition">
                                        <td class="px-6 py-4 text-gray-700">{{ $language->name }}</td>
                                        <td class="px-6 py-4 text-center space-x-2">
                                            <a href="{{ route('profile.languages.edit', $language->id) }}" 
                                               class="px-3 py-1 text-black rounded-lg shadow hover:bg-yellow-500 transition">
                                                Edit
                                            </a>
                                            <form action="{{ route('profile.languages.destroy', $language->id) }}" method="POST" class="inline-block" 
                    ...
                    @else
                        <p class="px-6 py-4 text-gray-500">You have no language records yet.</p>
                    @endif
                </div>
            </div>
