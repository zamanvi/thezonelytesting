        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <div class="p-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-700">Add New Education</h3>
                </div>

                <form action="{{ route('profile.educations.store') }}" method="POST" class="p-6 space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="number" name="passing_year" id="passing_year" value="{{ old('passing_year') }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 sm:text-sm" required>
                    </div>
                    ...
                    <div class="flex justify-end space-x-3">
                        <a href="{{ route('profile.educations.index') }}" 
                           class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-500 transition">
                            Cancel
                        </a>
                        <button type="submit" class="p-2 bg-blue-600 text-primary rounded-md shadow hover:bg-blue-700 transition">
                            Save
                        </button>
                    </div>
                </form>
