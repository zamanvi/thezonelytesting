            ...
            <div class="lg:col-span-8 space-y-10">
                ...
                <section
                    ...
                    <h2 class="text-2xl font-bold mb-8">Professional
                        Background</h2>
                    <div class="prose prose-slate lg:prose-lg max-w-none text-slate600 leading-relaxed">
                        ...
                        <div class="space-y-6">
                            @forelse($user->educations as $education)
                                <div class="flex items-start gap-4">
                                    <div class="w-40 h-10 rounded-xl bg-blue-50 flex itemscenter justify-center text-blue-600 font-bold shrink-0">
                                        {{ $education->degree }}
                                    </div>
                                    <div>
