            ...
            @foreach ($users as $user)
                <div class="col-lg-3 col-md-4 col-sm-6 mb-2 p-1">
                    <div class="team-card text-center shadow-sm rounded-3"> 
                        <a href="{{ route('frontend.service.show', $user->slug) }}"><h4 class="team-name">{{ $user->title }}</h4></a>
                        {{-- <a href="{{ route('frontend.service.show', $user->slug) }}"><h6 class="team-title">{{ $user->designation }}</h6></a> --}}
                        ...
                        <a href="{{ route('frontend.service.show', $user->slug) }}" class="btn btn-details">Details</a>
                    </div>
                </div>
            @endforeach
        </div>
