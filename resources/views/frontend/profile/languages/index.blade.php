...
<div class="pb-10 max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 mb-3">
        <div class="flex flex-wrap gap-3">
            ...
            <div class="flex items-center gap-2 px-4 py-2 bg-teal-50 border border-teal-100 rounded-2xl">
                <i class="fa-solid fa-language text-teal-600 text-xs"></i>
                <span class="text-sm font-semibold text-slate-700">{{ $item->name }}</span>
                <div class="flex items-center gap-1 ml-1">
                    <a href="{{ route('user.languages.edit', $item->id) }}"
                       class="w-6 h-6 flex items-center justify-center text-slate-400 hover:text-teal-700 transition">
    ...
    <div class="bg-white rounded-2xl border-2 border-dashed border-slate-200 p-10 text-center">
        <div class="w-14 h-14 bg-teal-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <i class="fa-solid fa-language text-teal-400 text-2xl"></i>
        </div>
