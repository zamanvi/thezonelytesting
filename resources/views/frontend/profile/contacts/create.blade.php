...
<div class="pb-10 max-w-2xl mx-auto">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h1 class="text-xl font-bold text-gray-900">Add Contact</h1>
            <p class="text-xs text-gray-500 mt-0.5">Shown in the Contact section of your public page</p>
        </div>
    </div>
    ...
    <form action="{{ route('user.contacts.store') }}" method="POST" class="space-y-4">
        @csrf
