...
<div class="pb-10 max-w-2xl mx-auto">
        ...
        <div class="flex items-start justify-between gap-4">
            <div class="min-w-0 flex-1">
                <div class="flex items-center gap-2 mb-1">
                    <span class="w-5 h-5 rounded-full bg-teal-100 text-teal-700 flex items-center justify-center shrink-0">
            ...
            <div class="flex items-center gap-2 shrink-0">
                <a href="{{ route('user.faqs.edit', $faq->id) }}"
                   class="w-8 h-8 flex items-center justify-center bg-slate-100 hover:bg-teal-100 hover:text-teal-700 text-slate-500 rounded-xl transition text-sm">
    ...
    <div class="bg-white rounded-2xl border-2 border-dashed border-slate-200 p-10 text-center">
        <div class="w-14 h-14 bg-teal-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <i class="fa-solid fa-circle-question text-teal-400 text-2xl"></i>
        </div>
    ...
    @if($faqs->count() > 0)
    <div class="mt-4 p-4 bg-teal-50 border border-teal-100 rounded-2xl flex items-start gap-3">
        <i class="fa-solid fa-lightbulb text-teal-600 text-sm mt-0.5 shrink-0"></i>
        <p class="text-xs text-teal-800">Tip: 4–6 questions works best. Cover pricing, response time, service area, and process.</p>
    </div>
    @endif
